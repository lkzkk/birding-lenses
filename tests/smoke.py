...
def main():
    ...
    assert 'height:clamp(320px,calc(100dvh - 275px),820px)' in uxcss
    assert '.control-drawer-body{' in uxcss and 'position:absolute' in uxcss
    assert "const setControlsOpen=open=>" in runtime
